...
Greetings! My name is Ryan Chitwood. This is `plotthedata`, my data science portfolio. The name comes from a statistics professor I had whose number one rule was "Always plot the data." Each post culminates in a flagship plot that tells the post's main story.
